<%@ Page Title="" Language="C#" MasterPageFile="~/Auditor/Auditor.Master" AutoEventWireup="true" CodeBehind="AuditorReportsView.aspx.cs" Inherits="SecureProctor.Auditor.AuditorReportsView" %>
                            ...
                            <asp:Button ID="btnInvoice" runat="server" Text="Invoice" OnClick="GenerateReport" CssClass="button_new blue" ToolTip="Generate Invoice" Style="vertical-align: top;" />&nbsp;&nbsp;&nbsp;<asp:ImageButton ID="BtnExportToExcel" runat="server" ImageUrl="~/Images/xls.jpeg"
                                ...
                                Width="22" Height="22" />&nbsp;&nbsp;
                                            <asp:ImageButton ID="BtnExportToPdf" runat="server" ImageUrl="~/Images/pdf.jpeg"
                                                ...
                                                Width="22" Height="22" Visible="false" />
                        </td>
                    </tr>
                </table>
                        ...
                        <td>
                            <table width="1000px" cellspacing="0" cellpadding="4">
                                <tr id="trexamfee" runat="server">
                                    ...
                                    <td id="tdexamfeelabel" runat="server" colspan="1" align="left" width="160px"><strong>
                                        <asp:Label ID="lblexamfeetitle" runat="server" Text="Total Exam Fee :" /></strong></td>
                                    <td id="tdexamfee" runat="server" colspan="1" width="80px">
                                        <asp:Label ID="lblExamFee" runat="server" /></td>
                                    <td id="tdondemandfeelabel" runat="server" colspan="1" width="190px"><strong>
                                        <asp:Label ID="lblondemandtitle" runat="server" Text="Total On-demand Fee :" /></strong></td>
                                    <td id="tdondemandfee" runat="server" colspan="1" width="70px">
                                        <asp:Label ID="lblOnDemandFee" runat="server" /></td>
                                    <td id="tdtotalfeelabel" runat="server" colspan="1" width="165px"><strong>
                                        <asp:Label ID="lbltotalfeetitle" runat="server" Text="Total Fee :" /></strong></td>
