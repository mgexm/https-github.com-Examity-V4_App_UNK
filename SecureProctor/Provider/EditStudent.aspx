<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditStudent.aspx.cs" Inherits="SecureProctor.Provider.EditStudent" %>
            ...
            <tr>
                <td>
                    <div class="heading customfont1">
                        <%=Resources.AppControls.Provider_EditStudent_Label_EditStudent%></div>
                </td>
            </tr>
            <tr>
                <td>
                        ...
                        <table cellpadding="0" cellspacing="2" width="100%" border="0">
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable" width="40%">
                                    <strong>
                                        <%= Resources.AppControls.Provider_EditStudent_Label_StudentFirstName %></strong>
                                </td>
                                <td align="left" width="60%">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$ Resources:AppMessages,Provider_EditStudent_Error_StudentFirstName %>"
                            ...
                            <tr class="gridviewRowstyle">
                                <td class="PopupLable">
                                    <strong>
                                        <%= Resources.AppControls.Provider_EditStudent_Label_StudentLastName%></strong>
                                </td>
                                <td align="left">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<%$ Resources:AppMessages,Provider_EditStudent_Error_StudentLastName %>"
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <%= Resources.AppControls.Provider_EditStudent_Label_EmailAddr%></strong>
                                </td>
                                <td align="left">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="<%$ Resources:AppMessages,Provider_EditStudent_Error_EmailAddr %>"
                                        ControlToValidate="lblEmailID" ForeColor="Red" Display="Dynamic" ValidationGroup="Edit">
                                    </asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" Display="Dynamic"
                                        ForeColor="Red" runat="server" ControlToValidate="lblEmailID" ErrorMessage="<%$ Resources:AppMessages,Provider_EditStudent_Error_InValidEmailAddr %>"
                          ...
                          <%--  <tr class="gridviewRowstyle">
                                <td class="PopupLable">
                                    <strong>
                                        <%= Resources.AppControls.Provider_EditStudent_Label_PhoneNumber%></strong>
                                </td>
                                <td align="left">
                            ...
                            <%--<tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <%= Resources.AppControls.Provider_EditStudent_Label_TimeZone%></strong>
                                </td>
                                <td align="left">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="RFTimeZone" InitialValue="Select Time Zone"
                                        Display="Dynamic" ControlToValidate="ddlTimeZone" ValidationGroup="Edit" ErrorMessage="<%$ Resources:AppMessages,Provider_EditStudent_Error_InValidTimeZone %>" />
                                </td>
                            </tr>--%>
                            <tr class="gridviewRowstyle">
                                <td class="PopupLable">
                                    <strong>
                                        <%= Resources.AppControls.Provider_EditStudent_Label_Status%></strong>
                                </td>
                                <td align="left">
                                       <telerik:RadScriptManager ID="sm1" runat="server">
                                    </telerik:RadScriptManager>
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <%= Resources.AppControls.Provider_EditStudent_Label_SpecialNeeds%></strong>
                                </td>
                                <td align="left">
                            ...
                            <tr class="gridviewRowstyle" runat="server" id="trcomments" visible="false">
                                <td class="PopupLable">
                                    <strong>
                                        <%= Resources.AppControls.Provider_EditStudent_Label_Comments%></strong>
                                </td>
                                <td align="left">
                            ...
                            <tr class="gridviewAlternatestyle" id="trUpdate" runat="server">
                                <td colspan="2" class="PopupButtons1">
                                    <telerik:RadButton ID="imgUpdate" runat="server" Text="<%$ Resources:AppControls,Provider_EditStudent_Button_Update %>"
                                        OnClick="btnUpdate_Click" Skin="<%$ Resources:AppConfigurations,Skin_Current %>"
                                        ValidationGroup="Edit" />
                                    <telerik:RadButton ID="imgCancel" runat="server" Text="<%$ Resources:AppControls,Provider_EditStudent_Button_Cancel %>"
