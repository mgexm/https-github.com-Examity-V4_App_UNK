<%@ Page Title="" Language="C#" MasterPageFile="~/CourseAdmin/CourseAdmin.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="SecureProctor.CourseAdmin.Home" %>
        ...
        <div class="app_inner_content">
            <table cellpadding="2" cellspacing="2" width="100%">
                ...
                <td width="100%" align="center" valign="top">
                    <div class="login_new1" style="min-height:350px;">
...
<table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td valign="top" width="33%" style="display: none;">
                                    <table width="100%" cellpadding="0" cellspacing="0" class="td_bg">
                                        <tr class="td_header">
                                            <td colspan="4" align="left">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <div style="padding: 10px;">
                                                                <table cellpadding="2" cellspacing="2">
                                                                    <tr>
                                                                        ...
                                                                        <td>Manages account information and password.
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
