<%@ Page Title="" Language="C#" MasterPageFile="~/Proctor/Proctor.Master" AutoEventWireup="true" CodeBehind="AutoProctorInbox.aspx.cs" Inherits="SecureProctor.Proctor.AutoProctorInbox" %>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <table width="100%">
                            <tr>
                                <td align="left" width="75%" valign="top">
                                    <img src="../Images/ImgAutoProctorInbox.png" alt="inbox" />
                                </td>
                ...
                <tr>
                    <td align="right" colspan="2">
                        <%--<asp:LinkButton ID="lblprocessedexamlink" runat="server" Text="Processed Exams"
                            ToolTip="Click here to Processed Exams" Font-Bold="true" Font-Underline="true">
                            </asp:LinkButton>--%>&nbsp;&nbsp;<%--OnClick="lblprocessedexamlink_Click">--%>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <div class="login_new1">
                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                ...
                                <tr>
                                    <td>
                                        <div class="login_new1">
                                            <telerik:radgrid id="gvAutoProctorInbox" runat="server" onneeddatasource="gvAutoProctorInbox_NeedDataSource"
                                                autogeneratecolumns="False" allowpaging="True" allowsorting="True" skin="<%$ Resources:SecureProctor,Telerik_Grid_Skin %>"
                                                cellspacing="0" gridlines="None" onitemcommand="gvAutoProctorInbox_ItemCommand" enablelinqexpressions="false"  
                                                OnSortCommand="gvAutoProctorInbox_SortCommand">
                                                            ...
                                                            <ItemTemplate>
                                                             ...
                                                             <asp:HyperLink ID="lnkView" runat="server" Text="View"  
                                                                        CommandArgument='<%# Eval("TransID")%>' Font-Underline="true"  ForeColor="Blue" NavigateUrl='<%#GetUrl(Eval("TransID").ToString())%>' Target="_blank"
                                                                         ></asp:HyperLink>   <%-- Visible='<%# Convert.ToBoolean(Eval("VideoStatus"))%>'--%>
                                                                 </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Center" Width="3%" />
                                                            <HeaderStyle Font-Bold="true" />
                                                        </telerik:GridTemplateColumn>
