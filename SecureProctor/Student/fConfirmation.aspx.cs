...
{
    public partial class fConfirmation : BaseClass
    {
        ...
        protected void LogPayments(Int64 intTransID, decimal decExamFee, decimal decOnDemandFee)
        {
            ...
            if (Request.Form["Transaction_Tag"] != null)
                objBEStudent.strOrderID = "PZ : TransactionTag=" + Request.Form["Transaction_Tag"].ToString() + ",AuthCode=" + Request.Form["Authorization_Num"].ToString();
