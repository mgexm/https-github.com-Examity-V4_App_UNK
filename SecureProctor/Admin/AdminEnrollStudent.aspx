<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdminEnrollStudent.aspx.cs" Inherits="SecureProctor.Admin.AdminEnrollStudent" %>
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr class="gridviewRowstyle">
                                                    ...
                                                    <td width="15%" align="left">
                                                        <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblFirstName" Text="Student ID : "
                                                 ...
                                                 <tr class="gridviewAlternatestyle">
                                                    ...
                                                    <td width="15%" align="left">
                                                        <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblInstructorName" Text="Instructor Name : "
                                                            runat="server"></asp:Label>
                                                        </strong>
                                                    </td>
                                                    <td width="75%" align="left">
                                                        <telerik:RadComboBox ID="ddlprovider" runat="server" AppendDataBoundItems="True" Skin="Web20" OnSelectedIndexChanged="ddlProviderName_SelectedIndexChanged"
                                                            DropDownAutoWidth="Enabled" AutoPostBack="true"  Filter="Contains" MarkFirstMatch="true">
                                                        </telerik:RadComboBox>
                                                ...
                                                <tr class="gridviewRowstyle">
                                                    ...
                                                    <td width="75%" align="left">
                                                        <telerik:RadButton ID="btnEnroll" runat="server" Text="Enroll" Skin="Web20" Width="8%"
                                                            OnClick="btnEnroll_Click"  ValidationGroup="submit">
                                                        </telerik:RadButton>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <telerik:RadGrid ID="gvExamStatus" runat="server" OnNeedDataSource="gvExamStatus_NeedDataSource"
                                                ...
                                                CellSpacing="0" GridLines="None" OnItemCommand="gvExamStatus_ItemCommand" EnableLinqExpressions="false">
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Actions" HeaderStyle-HorizontalAlign="Center"
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:ImageButton ID="lblDelete" runat="server" Text="Delete" ImageUrl="~/Images/delete_s.png"
                                                                    OnClick="lblStudentNameDelete_Click" CommandArgument='<%#Eval("EnrollmentID") %>'>
                                                                </asp:ImageButton>
                                                            </ItemTemplate>
