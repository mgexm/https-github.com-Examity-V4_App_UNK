<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteCourse.aspx.cs" Inherits="SecureProctor.Admin.DeleteCourse" %>
    ...
    <table cellpadding="5" cellspacing="5" width="100%">
        <tr>
            <td>
                    ...
                    <%=Resources.AppControls.Admin_DeleteCourse_Label_DeleteCourse%></div>
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <table cellpadding="0" cellspacing="2" width="100%" border="0">
                        ...
                        <tr class="gridviewAlternatestyle">
                            <td class="PopupLable" width="30%">
                              <strong><%= Resources.AppControls.Admin_DeleteCourse_Label_CourseID %></strong>
                            </td>
                        ...
                        <tr class="gridviewRowstyle">
                            <td class="PopupLable">
                                <strong><%= Resources.AppControls.Admin_DeleteCourse_Label_CourseName %></strong>
                            </td>
                            <td align="left">
                        ...
                        <tr class="gridviewRowstyle" id="trDelete" runat="server">
                            ...
                            <td class="PopupButtons">
                                <telerik:RadButton ID="btnDelete" runat="server" Text="<%$ Resources:AppControls,Admin_DeleteCourse_Button_Delete %>"
                                    OnClick="btnDelete_Click" Skin="<%$ Resources:AppConfigurations,Skin_Current %>"
                                    ValidationGroup="Edit" />
                                <telerik:RadButton ID="btnBack" runat="server" Text="<%$ Resources:AppControls,Admin_DeleteCourse_Button_Cancel %>"
