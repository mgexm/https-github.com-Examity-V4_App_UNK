<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCourse.aspx.cs" Inherits="SecureProctor.Provider.AddCourse" %>
        ...
        <tr>
            <td>
                <div class="heading customfont1">
                    <%= Resources.AppControls.Provider_AddCourse_Label_AddCourse%></div>
            </td>
        </tr>
