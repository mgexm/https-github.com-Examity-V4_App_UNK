...
namespace SecureProctor.Proctor
{
    public partial class AjaxResponse : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Request.Form["Method"].ToString() == "ExamStatus")
                {
                    try
                    {
                ...
                else if (Request.Form["Method"].ToString() == "ExamiKEYScore")
                {
                    try
                    {
                        BECommon objBECommon = new BECommon();
                ...
                else if (Request.Form["Method"].ToString() == "GetMeetingID")
                {
                    try
                    {
                ...
                else if (Request.Form["Method"].ToString() == "GetBrowserInfo")
                {
                    try
                    {
                        BEProctor objBEProctor = new BEProctor();
                ...
                else if (Request.Form["Method"].ToString() == "ExamTimer")
                {
                    BEProctor objBEProctor = new BEProctor();
                    BProctor objBProctor = new BProctor();
                ...
                else if (Request.Form["Method"].ToString() == "StudentIdentity")
                {
                ...
                else if (Request.Form["Method"].ToString() == "StudentExamStatus")
                {
                    try
                    {
                        BECommon objBECommon = new BECommon();
                ...
                else if (Request.Form["Method"].ToString() == "GetStudentIdentity")
                {
                ...
                else if (Request.Form["Method"].ToString() == "GetMeetingStatus")
                {
                    BEProctor objBEProctor = new BEProctor();
                    BProctor objBProctor = new BProctor();
                    objBEProctor.IntTransID = Convert.ToInt64(AppSecurity.Decrypt(Request.Form["TransID"].ToString()).Trim());
                ...
                else if (Request.Form["Method"].ToString() == "GetProceedStatus")
                {
                    BEProctor objBEProctor = new BEProctor();
                    BProctor objBProctor = new BProctor();
                    objBEProctor.IntTransID = Convert.ToInt64(AppSecurity.Decrypt(Request.Form["TransID"].ToString()).Trim());
                ...
                else if (Request.Form["Method"].ToString() == "StartExam")
                {
                    BEProctor objBEProctor = new BEProctor();
                    BProctor objBProctor = new BProctor();
                    objBEProctor.IntTransID = Convert.ToInt64(AppSecurity.Decrypt(Request.Form["TransID"].ToString()).Trim());
                ...
                else if (Request.Form["Method"].ToString() == "GetExamiKNOWStatus")
                {
                ...
                else if (Request.Form["Method"].ToString() == "ExamCompleted")
                {
                ...
                else if (Request.Form["Method"].ToString() == "ProctorSubmitTransaction")
                {
                ...
                else if (Request.Form["Method"].ToString() == "CreateGotoMeetingSession")
                {
                    try
                    {
                        string TransID = AppSecurity.Decrypt(HttpUtility.UrlDecode(Request.Form["TransID"].ToString()));
                ...
                else if (Request.Form["Method"].ToString() == "CreateWebEx")
                {
                    #region CreateWebEx
                    try
                    {
                ...
                else if (Request.Form["Method"].ToString() == "ResetWebEx")
                {
                    #region ResetWebEx
                    try
                    {
                ...
                else if (Request.Form["Method"].ToString() == "CreateZoomMeetingSession")
                {
                ...
                else if (Request.Form["Method"].ToString() == "ResetZoomMeetingSession")
                {
                ...
                else if (Request.Form["Method"].ToString() == "ResetGotoMeetingSession")
                {
                    try
                    {
                        string TransID = AppSecurity.Decrypt(HttpUtility.UrlDecode(Request.Form["TransID"].ToString()));
