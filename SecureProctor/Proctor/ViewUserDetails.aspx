<%@ Page Title="" Language="C#" MasterPageFile="~/Proctor/Proctor.Master" AutoEventWireup="true"
    CodeBehind="ViewUserDetails.aspx.cs" Inherits="SecureProctor.Proctor.ViewUserDetails" %>
                                                    ...
                                                    <tr>
                                                        <td style="width: 50%;" valign="top">
                                                            <table width="100%" cellpadding="2" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        <asp:Image ID="imgstudent" Width="292" Height="183" runat="server" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                        ...
                                        <tr>
                                            <td>
                                                <telerik:RadGrid ID="gvStudentExamStatus" runat="server" OnNeedDataSource="gvStudentExamStatus_NeedDataSource"
                                                    ...
                                                    OnItemCommand="gvStudentExamStatus_ItemCommand" FilterItemStyle-BackColor="#DCEDFD">
                                                    ...
                                                    <MasterTableView AllowFilteringByColumn="true" AllowNaturalSort="false">
                                                        ...
                                                        <Columns>
                                                            <telerik:GridBoundColumn DataField="TransID" HeaderText="<%$ Resources:SecureProctor,Grid_Header_TransactionID %>"
                                                                SortExpression="TransID" UniqueName="TransID" HeaderStyle-HorizontalAlign="Center" FilterControlWidth="50%">
