<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditExam.aspx.cs" Inherits="SecureProctor.Provider.EditExam" %>
            ...
            <tr>
                <td>
                    <div class="heading customfont1">
                        <%=Resources.AppControls.Provider_EditExam_Label_EditExam%>
                    </div>
                </td>
            </tr>
                        ...
                        <table cellpadding="0" cellspacing="2" width="100%" border="0">
                            <tr class="gridviewRowstyle">
                                <td width="35%" class="PopupLable">
                                    <strong>
                                        <asp:Label ID="lblCourse" runat="server" Text="<%$ Resources:AppControls,Provider_EditExam_Label_CourseName %>"></asp:Label></strong>:
                                </td>
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="lblExam" Text="<%$ Resources:AppControls,Provider_EditExam_Label_ExamName %>"
                                ...
                                <td align="left">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<%$ Resources:AppMessages,Provider_EditExam_Error_ExamName %>"
                            ...
                            <tr class="gridviewRowstyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="lblSecurityLevel" Text="<%$ Resources:AppControls,Provider_EditExam_Label_ExamSecurityLevel %>"
                                            runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="lblExamhrs" Text="<%$ Resources:AppControls,Provider_EditExam_Label_DurationOfExam %>"
                                            runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left" valign="bottom">
                                    <asp:Label ID="lblHours" runat="server" Text="<%$ Resources:AppControls,Provider_EditExam_Label_HH %>"></asp:Label>&nbsp;
                                <telerik:RadComboBox ID="ddlHours" runat="server" AppendDataBoundItems="True" Skin="<%$ Resources:AppConfigurations,Skin_Current %>"
                                    Width="50">
                                </telerik:RadComboBox>
                                    &nbsp;&nbsp;:&nbsp;&nbsp;<asp:Label ID="lblMinutes" runat="server" Text="<%$ Resources:AppControls,Provider_EditExam_Label_MM %>"></asp:Label>&nbsp;
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="lblAccessExam" Text="<%$ Resources:AppControls,Provider_EditExam_Label_ExamLinkToAccess %>"
                                            runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
                                    <textarea id="txtAccessExam" runat="server" width="350" maxlength="2000" rows='5'
                                        cols='42' skin="<%$ Resources:AppConfigurations,Skin_Current %>" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="<%$ Resources:AppMessages,Provider_EditExam_Error_ExamURL %>"
                             ...
                             <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="lblStartN" Text="<%$ Resources:AppControls,Provider_AddExam_Label_ExamStartDateAndTime %>"
                                            runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
                                    <telerik:RadDatePicker ID="ExamStartRadDatePicker" runat="server" DateInput-ReadOnly="false" Width="120px" Skin="<%$ Resources:AppConfigurations,Skin_Current %>">
                                      <DateInput ID="DateInput" EmptyMessage="MM/DD/YYYY" runat="server" DisplayDateFormat="MM/dd/yyyy">

                                        </DateInput>
                                    </telerik:RadDatePicker>

                                    <telerik:RadTimePicker ID="ExamStartRadTimePicker" runat="server" DateInput-ReadOnly="true" Width="90px" Skin="Web20" Columns="6">
                                    <TimeView Interval="00:30:00" Width="420px" Columns="6"></TimeView> 
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="RFV1" ControlToValidate="ExamStartRadDatePicker"
                            ...
                            <tr class="gridviewRowstyle">
                                ...
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="lblEndN" Text="<%$ Resources:AppControls,Provider_AddExam_Label_ExamEndDateAndTime %>"
                                            runat="server"></asp:Label></strong>:
                                </td>

                                <td>

                                    <telerik:RadDatePicker ID="ExamEndRadDatePicker" runat="server" DateInput-ReadOnly="false" Width="120px" Skin="<%$ Resources:AppConfigurations,Skin_Current %>">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="ExamEndRequiredFieldValidator" ControlToValidate="ExamEndRadDatePicker"
                                        ErrorMessage="<%$ Resources:AppMessages,Provider_AddExam_Error_StartTime %>"
                                        ValidationGroup="submit"></asp:RequiredFieldValidator>
                                    <asp:RequiredFieldValidator runat="server" ID="RF4" ControlToValidate="ExamEndRadTimePicker"
                                        ErrorMessage="<%$ Resources:AppMessages,Provider_AddExam_Error_EndTime %>"
                                        ValidationGroup="submit"></asp:RequiredFieldValidator>
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="ExamStartRadDatePicker"
                            ...
                            <tr class="gridviewAlternatestyle" runat="server" id="trUploadedFiles">
                                <td class="PopupLable">
                             ...
                             <td align="left">
                                            ...
                                            <telerik:RadGrid ID="gvUploadFiles" runat="server"   AutoGenerateColumns="False"  CellSpacing="0" GridLines="None"  PageSize="5" Width="50%">
                ...
                <MasterTableView AllowFilteringByColumn="false" FilterItemStyle-BackColor="#ffffff" PageSize="5"
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-ForeColor="Black" HeaderStyle-BackColor="White" HeaderStyle-Width="0px"
                     ...
                     <asp:LinkButton ID="lnkOriginalFileName" runat="server"  Text='<%# Eval("OriginalFileName")%>' CommandArgument='<%# Bind("StoredFileName")%>' CommandName="uploadFile" Font-Underline="true" OnClick="lnlFile_Click"/>
                         ...
                         &nbsp;
                         <asp:ImageButton ID="imgDelete" runat="server" ImageUrl="~/Images/icon_cancel.png" OnClick="imgDelete_Click"  CommandArgument='<%# Bind("StoredFileName")%>' Width="12px"/>
                    </ItemTemplate>
                    ...
                    <HeaderStyle Font-Bold="true" />
                            ...
                            <tr class="gridviewAlternatestyle">
                                 <td class="PopupLable">
                                    <asp:Label ID="lblNewUploads" runat="server" Text="Upload files"
                                        Font-Bold="true"></asp:Label>:
                                </td>
 ...
 <telerik:RadAsyncUpload runat="server"  ID="AdminUpload" Width="200px" MultipleFileSelection="Automatic"   UploadedFilesRendering="BelowFileInput"  AllowedFileExtensions="jpg,jpeg,png,gif,doc,docx,xlsx,xls,txt,pdf" MaxUploadSize="10000000">
                              ...
                              <tr>
                               ...
                               <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="Label15" Text="Exam UserName" runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
                                    <telerik:RadTextBox ID="txtExamUserName" runat="server" Width="250" MaxLength="100" Skin="<%$ Resources:AppConfigurations,Skin_Current %>">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="Label4" Text="Exam Password"
                                            runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
                                    <telerik:RadTextBox ID="txtExamPassword" runat="server" Width="250" MaxLength="100" Skin="<%$ Resources:AppConfigurations,Skin_Current %>">
                                    </telerik:RadTextBox>
                                    <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$ Resources:AppMessages,Provider_EditExam_Error_ExamPassword %>"
                                    ControlToValidate="txtExamPassword" ForeColor="Red" ValidationGroup="submit"></asp:RequiredFieldValidator>--%>
                                </td>
                            </tr>
                            ...
                            <tr class="gridviewRowstyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="Label6" Text="<%$ Resources:AppControls,Provider_EditExam_Label_Status %>"
                                            runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
                                    <telerik:RadComboBox ID="ddlStatus" runat="server" DropDownAutoWidth="Enabled" Skin="<%$ Resources:AppConfigurations,Skin_Current %>">
                                        <Items>
                                            ...
                                            <table cellpadding="2" cellspacing="0" width="100%">
                                                ...
                                                <tr class="gridviewAlternatestyle">
                                                    <td class="PopupLable" width="50%">
                                                        <strong>
                                                            <asp:Label ID="Label8" Text="<%$ Resources:AppControls,Provider_AddExam_Label_LockDownBrowser %>"
                                                                runat="server"></asp:Label></strong>:
                                                    </td>
                                                    <td align="left" valign="bottom">
                                                ...
                                                <tr class="gridviewAlternatestyle">
                                                    <td class="PopupLable">
                                                        <strong>
                                                            <asp:Label ID="Label10" Text="Exam Fee Paid By"
                                                                runat="server"></asp:Label></strong>:
                                                    </td>
                                                    <td align="left">
                                                ...
                                                <tr class="gridviewAlternatestyle">
                                                    <td class="PopupLable">
                                                        <strong>
                                                            <asp:Label ID="Label11" Text="On-demand Fee Paid By"
                                                                runat="server"></asp:Label></strong>:
                                                    </td>
                                                    <td align="left">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" width="25%">
                                                <asp:UpdatePanel ID="Updatepanel" runat="server">
                                                    <ContentTemplate>
                                                        <telerik:RadComboBox ID="ddlreusespecialinstructions" runat="server" 
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td colspan="3">
                                                        <telerik:RadGrid ID="gvSpecial" runat="server" AllowMultiRowSelection="false"
                                                            AutoGenerateColumns="False" Skin="<%$ Resources:AppConfigurations,Skin_Current %>"
                                                            CellSpacing="0" GridLines="None" MasterTableView-DataKeyNames="RuleID" OnItemCommand="gvSpecial_ItemCommand" OnEditCommand="gvSpecial_EditCommand" OnUpdateCommand="gvSpecial_UpdateCommand" OnCancelCommand="gvSpecial_CancelCommand">
                                                            <GroupingSettings CaseSensitive="false" />
                                                            <ClientSettings>
                                                            ...
                                                            <MasterTableView AllowFilteringByColumn="false" FilterItemStyle-BackColor="#DCEDFD"
                                                                ...
                                                                <Columns>
                                                                      <telerik:GridTemplateColumn UniqueName="RuleID" Visible="false">
                                                                     
                                                                        <ItemTemplate>
                                                                           <asp:Label ID="lblRuleID" runat="server" Text='<%# (Eval("RuleID")) %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="Center" Width="10%" />
                                                                    ...
                                                                    <telerik:GridTemplateColumn>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:CheckBox ID="ChkProctor" runat="server" Checked='<%# Convert.ToBoolean(Eval("Proctor")) %>' AutoPostBack="true" OnCheckedChanged="ChkProctor_CheckedChanged" CausesValidation="false" />
                                                                        </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="Center" Width="10%" />
                                                                        <HeaderStyle Width="10%" />
                                                                    </telerik:GridTemplateColumn>
                                                                    <telerik:GridTemplateColumn>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:CheckBox ID="ChkStudent" runat="server" Checked='<%# Convert.ToBoolean(Eval("Student")) %>' AutoPostBack="true" OnCheckedChanged="ChkStudent_CheckedChanged" CausesValidation="false" />
                                                                        </ItemTemplate>
                                                                        <ItemStyle HorizontalAlign="Center" Width="10%" />
                                                                        <HeaderStyle Width="10%" />
                                                                    </telerik:GridTemplateColumn>
                                                                        ...
                                                                        <table width="100%" cellpadding="5" cellspacing="5">
                                                                            <tr>
                                                                                ...
                                                                                <td align="left" style="width: 20%" valign="top">
                                                                                    <telerik:RadTextBox ID="txtRuleDescription" runat="server" Skin="Web20" Text='<%# Eval("RuleDesc")%>' Width="500px" Height="100px" TextMode="MultiLine">
                                                                                    </telerik:RadTextBox>
                                                                                </td>
                                                                                <%--<td align="right"></td>--%>
                                                ...
                                                <tr>
                                                    <td width="70%" valign="middle" align="center" style="border-bottom: 1px solid #4e75b3; border-left: 1px solid #4e75b3; padding-top: 10px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea id="taAdditionalRules" runat="server" rows="3" cols="60"></textarea>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Rules cannot be blank"
                                                            ControlToValidate="taAdditionalRules" ForeColor="Red" ValidationGroup="AddRules"></asp:RequiredFieldValidator>
                                                    </td>
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupButtons1" colspan="3">
                                    <telerik:RadButton ID="BtnUpdateExam" runat="server" Skin="<%$ Resources:AppConfigurations,Skin_Current %>"
                                        Text="<%$ Resources:AppControls,Provider_EditExam_Button_SaveExam %>" OnClick="BtnUpdateExam_Click"
            ...
            <tr id="trEditExamConfirm" runat="server">
                <td>
                    <div class="login_new1">
                        <table cellpadding="0" cellspacing="3" width="100%" border="0">
                            ...
                            <tr class="gridviewRowstyle">
                                <td class="PopupLable">
                                    <asp:Label ID="lblConfirmUpload" runat="server" Text="Uploaded files"
                                        Font-Bold="true"></asp:Label>:
                                </td>
                                <td align="left">

                                    <telerik:RadGrid ID="gvFilesUploaded" runat="server"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-ForeColor="Black" HeaderStyle-BackColor="White" HeaderStyle-Width="0px"
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="Label14" Text="Exam UserName"
                                            runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="Label3" Text="<%$ Resources:AppControls,Provider_AddExam_Label_ExamPassword %>"
                                            runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="Label7" Text="<%$ Resources:AppControls,Provider_EditExam_Label_Status %>"
                                            runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
                                ...
                                <td colspan="2">
                                    <table cellpadding="2" cellspacing="0" width="100%">
                                        <tr class="gridviewAlternatestyle">
                                            <td class="PopupLable" width="35%">
                                                <strong>
                                                    <asp:Label ID="Label5" Text="<%$ Resources:AppControls,Provider_AddExam_Label_BufferTime %>"
                                                        runat="server"></asp:Label></strong>:
                                            </td>
                                            <td align="left" width="65%">
                                        ...
                                        <tr class="gridviewAlternatestyle">
                                            <td class="PopupLable" width="50%">
                                                <strong>
                                                    <asp:Label ID="Label9" Text="<%$ Resources:AppControls,Provider_AddExam_Label_LockDownBrowser %>"
                                                        runat="server"></asp:Label></strong>:
                                            </td>
                                            <td align="left" valign="bottom">
                ...
                <div class="login_new1">
                    <table cellpadding="0" cellspacing="2" width="100%" border="0">
                        <tr class="gridviewRowstyle">
                            <td width="35%"  class="PopupLable">
                                <strong>
                                    <asp:Label ID="lblConfirmCourse" runat="server" Text="<%$ Resources:AppControls,Provider_EditExam_Label_CourseName %>"></asp:Label></strong>:
                            </td>
                            <td width="65%" align="left">
                                <asp:Label ID="lblConfirmCourseValue" runat="server"></asp:Label>
                            </td>
                        ...
                        <tr class="gridviewAlternatestyle">
                            <td  class="PopupLable">
                                <strong>
                                    <asp:Label ID="lblConfirmExam" Text="<%$ Resources:AppControls,Provider_EditExam_Label_ExamName %>"
                                        runat="server"></asp:Label></strong>:
                            </td>
                            <td align="left">
                                <asp:Label ID="lblConfirmExamValue" Text="<%$ Resources:AppControls,Provider_EditExam_Label_ExamName %>"
                                    runat="server"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr class="gridviewRowstyle">
                            <td  class="PopupLable">
                                <strong>
                                    <asp:Label ID="lblConfirmSecurityLevel" Text="<%$ Resources:AppControls,Provider_EditExam_Label_ExamSecurityLevel %>"
                                        runat="server"></asp:Label>
                                </strong>:
                            </td>
                            <td align="left">
                        ...
                        <tr class="gridviewAlternatestyle">
                            <td  class="PopupLable">
                                <strong>
                                    <asp:Label ID="lblConfirmExamDuration" Text="<%$ Resources:AppControls,Provider_EditExam_Label_DurationOfExam %>"
                                        runat="server"></asp:Label></strong>:
                            </td>
                            <td align="left" valign="bottom">
                                <asp:Label ID="lblConfirmExamDurationValue" runat="server"></asp:Label>
                        ...
                        <tr class="gridviewAlternatestyle">
                            <td  class="PopupLable">
                                <strong>
                                    <asp:Label ID="lblConfirmBufferTime" Text="<%$ Resources:AppControls,Provider_EditExam_Label_BufferTime %>"
                                        runat="server"></asp:Label></strong>:
                            </td>
                            <td align="left" valign="bottom">
                                <asp:Label ID="lblConfirmBufferTimeValue" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr class="gridviewRowstyle">
                            <td  class="PopupLable">
                                <strong>
                                    <asp:Label ID="lblConfirmExamLink" Text="<%$ Resources:AppControls,Provider_EditExam_Label_ExamLinkToAccess %>"
                                        runat="server"></asp:Label></strong>:
                            </td>
                            <td align="left">
                                <asp:Label ID="lblConfirmExamLinkValue" runat="server" CssClass="LineBreak"></asp:Label>
                            </td>
                        </tr>
                        <tr class="gridviewAlternatestyle">
                            <td  class="PopupLable">
                                <strong>
                                    <asp:Label ID="lblConfirmStartDate" Text="<%$ Resources:AppControls,Provider_EditExam_Label_ExamStartDate %>"
                                        runat="server"></asp:Label></strong>:
                            </td>
                            <td align="left">
                                <asp:Label ID="lblConfirmStartDateValue" runat="server"></asp:Label>
                        ...
                        <tr class="gridviewRowstyle">
                            <td  class="PopupLable">
                                <strong>
                                    <asp:Label ID="lblConfirmEndDate" Text="<%$ Resources:AppControls,Provider_EditExam_Label_ExamEndDate %>"
                                        runat="server"></asp:Label></strong>:
                            </td>
                            <td align="left">
                                <asp:Label ID="lblConfirmEndDateValue" runat="server"></asp:Label>
                        ...
                        <tr class="gridviewRowstyle">
                            <td  class="PopupLable">
                                <asp:Label ID="lblConfirmUpload" runat="server" Text="<%$ Resources:AppControls,Provider_EditExam_Label_UploadFile %>"
                                    Font-Bold="true"></asp:Label>:
                            </td>
                            <td align="left">
                                <asp:Label ID="lblConfirmUploadValue" runat="server"></asp:Label>
                                <asp:LinkButton ID="lnkConfirmUploadValue" runat="server" ForeColor="Blue" Font-Underline="true"
                         ...
                         <tr class="gridviewAlternatestyle">
                            <td  class="PopupLable">
                                <strong>
                                    <asp:Label ID="Label8" Text="Exam Password"
                                        runat="server"></asp:Label></strong>:
                            </td>
                            <td align="left">
                                <asp:Label ID="lblExamPassword1" 
                                    runat="server"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr class="gridviewAlternatestyle">
                            <td colspan="2" style="padding-top: 5px; padding-bottom: 5px;">
                                <asp:UpdatePanel ID="upnotesConfirm" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadGrid ID="gvnotesConfirm" runat="server" OnNeedDataSource="gvnotesConfirm_NeedDataSource"
                                            ...
                                            <MasterTableView AllowFilteringByColumn="false" FilterItemStyle-BackColor="#DCEDFD"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="NoteDesc" HeaderText="<%$ Resources:AppControls,Provider_EditExam_GridHeader_NotesForProdAndAud %>"
                                                        SortExpression="Text" UniqueName="NoteDesc" HeaderStyle-HorizontalAlign="Center">
                        ...
                        <tr class="gridviewAlternatestyle">
                            <td colspan="2" style="padding-top: 5px; padding-bottom: 5px;">
                                <asp:UpdatePanel ID="upgvRulesConfirm" runat="server">
                                    <ContentTemplate>
                                        <telerik:RadGrid ID="gvRulesConfirm" runat="server" OnNeedDataSource="gvRulesConfirm_NeedDataSource"
                                            AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" Skin="<%$ Resources:AppConfigurations,Skin_Current %>"
                                            ...
                                            <MasterTableView AllowFilteringByColumn="false" FilterItemStyle-BackColor="#DCEDFD"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="RuleDesc" HeaderText="<%$ Resources:AppControls,Provider_EditExam_GridHeader_RulesForStudent %>"
                                                        SortExpression="Text" UniqueName="RuleDesc" HeaderStyle-HorizontalAlign="Center">
                                                        <ItemStyle HorizontalAlign="Center" Width="100%" />
                                                        <HeaderStyle Font-Bold="true" />
                                                    </telerik:GridBoundColumn>
                                                </Columns>
