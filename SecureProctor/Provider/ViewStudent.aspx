<%@ Page Title="" Language="C#" MasterPageFile="~/Provider/Provider.Master" AutoEventWireup="true" CodeBehind="ViewStudent.aspx.cs" Inherits="SecureProctor.Provider.ViewStudent" %>
                        ...
                        <tr>
                            <td>
                                <div class="heading customfont1">
                                   <img src="../Images/StudentDetails.png" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width: 50%;" valign="top">
                                                            <table width="100%" cellpadding="2" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        <asp:Image ID="imgstudent" runat="server" Width="292" Height="183"  ImageUrl="~/Images/noimage.png"/>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                            <tr class="gridviewHeaderstyle">
                                                                                <td align="left" colspan="4" style="line-height: 35px;">
                                                                                    &nbsp;&nbsp;&nbsp;<strong><%= Resources.AppControls.Provider_ViewStudent_Label_StudentProfile%></strong></td>
                                                                            </tr>
                                                                            <tr class="gridviewAlternatestyle">
                                                                                ...
                                                                                <td align="left">
                                                                                    <strong>
                                                                                        <%= Resources.AppControls.Provider_ViewStudent_Label_PhoneNumber%></strong>&nbsp;&nbsp;&nbsp;
                                                                                </td>
                                                                                <td align="left">
                                                                                    :
                                                                            ...
                                                                            <tr class="gridviewRowstyle">
                                                                                ...
                                                                                <td align="left">
                                                                                    <strong>
                                                                                        <%= Resources.AppControls.Provider_ViewStudent_Label_TimeZone%></strong>&nbsp;&nbsp;&nbsp;
                                                                                </td>
                                                                                <td align="left">
                                                                                    :
                                                                            ...
                                                                            <tr class="gridviewAlternatestyle">
                                                                                ...
                                                                                <td align="left">
                                                                                    <strong>
                                                                                        <%= Resources.AppControls.Provider_ViewStudent_Label_SpecialNeeds%></strong>&nbsp;&nbsp;&nbsp;
                                                                                </td>
                                                                                <td align="left">
                                                                                    :
                                                                            ...
                                                                            <tr class="gridviewRowstyle">
                                                                                ...
                                                                                <td align="left">
                                                                                    <strong>
                                                                                        <%= Resources.AppControls.Provider_ViewStudent_Label_Comments%></strong>&nbsp;&nbsp;&nbsp;
                                                                                </td>
                                                                                <td align="left">
                                                                                    :
                                            ...
                                            <td>
                                                <telerik:RadGrid ID="gvTransDetails" runat="server" OnNeedDataSource="gvTransDetails_NeedDataSource"
                                                    ...
                                                    <MasterTableView AllowFilteringByColumn="true" FilterItemStyle-HorizontalAlign="Center" AllowNaturalSort="false">
                                                        <Columns>
                                                            <telerik:GridBoundColumn DataField="TransID" HeaderText="<%$ Resources:AppControls,Provider_ViewStudent_GridHeader_TransID %>"
                                                                SortExpression="TransID" UniqueName="TransID" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle Font-Bold="true" />
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn DataField="CourseName" HeaderText="<%$ Resources:AppControls,Provider_ViewStudent_GridHeader_CourseName %>"
                                                                SortExpression="CourseName" UniqueName="CourseName" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle Font-Bold="true" />
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn DataField="ExamName" HeaderText="<%$ Resources:AppControls,Provider_ViewStudent_GridHeader_ExamName %>"
                                                                SortExpression="ExamName" UniqueName="ExamName" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle Font-Bold="true" />
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn DataField="ScheduleTime" HeaderText="<%$ Resources:AppControls,Provider_ViewStudent_GridHeader_ScheduleTime %>"
                                                                SortExpression="ScheduleTime" UniqueName="ScheduleTime" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle Font-Bold="true" />
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridTemplateColumn HeaderText="<%$ Resources:AppControls,Provider_ViewStudent_GridHeader_ExamStatus %>"
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="<%$ Resources:AppControls,Provider_ViewStudent_GridHeader_View %>"
                                                                HeaderStyle-HorizontalAlign="Center" AllowFiltering="false">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkView" runat="server" Text="<%$ Resources:AppControls,Provider_ViewStudent_GridHeader_View %>"
