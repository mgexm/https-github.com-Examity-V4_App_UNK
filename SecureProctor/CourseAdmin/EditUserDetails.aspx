<%@ Page Title="" Language="C#" MasterPageFile="~/CourseAdmin/CourseAdmin.Master" AutoEventWireup="true" CodeBehind="EditUserDetails.aspx.cs" Inherits="SecureProctor.CourseAdmin.EditUserDetails" %>
                ...
                <div class="login_new1">
                    <table cellpadding="3" cellspacing="4" width="100%" border="0">
                        <tr class="gridviewAlternatestyle">
                            <td align="left" width="40%">&nbsp;&nbsp;&nbsp; <strong>Student First Name</strong>&nbsp;&nbsp;&nbsp;
                            </td>
                        ...
                        <tr id="imgSuccess" runat="server">
                            ...
                            <td valign="middle" align="left">&nbsp;&nbsp;<asp:Label ID="lblMsg" runat="server"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </div>
