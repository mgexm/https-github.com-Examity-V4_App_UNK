...
namespace SecureProctor.Provider
{
    public partial class Students : BaseClass
    {
        ...
        protected void GetStudents()
        {
            ...
            //new BProvider().BGetStudents(objBEExamProvider);
            objBEExamProvider.IntProviderID = Convert.ToInt32(Session[BaseClass.EnumPageSessions.USERID]);
            new BProvider().BGetProviderStudentsFiltered(objBEExamProvider);

            gvStudents.DataSource = objBEExamProvider.DtResult;
