...
namespace SecureProctor.Admin
{
    public partial class MyProfile : BaseClass
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ((LinkButton)this.Page.Master.FindControl("lnkMyProfile")).CssClass = "main_menu_active";
            ...
            if (Page.IsValid)
            {
               ...
               // objBEUser.StrGender = ddlGender.SelectedValue;
                ...
                if (objBEUser.IntResult == 1)
                {
                    ...
                    Session["UserName"] = txtFirstName.Text + " " + txtLastName.Text + " [ Admin ]";
                    Label lblUserName = this.Master.FindControl("lblUser") as Label;
                    lblUserName.Text = txtFirstName.Text + " " + txtLastName.Text + " [ Admin ]";
