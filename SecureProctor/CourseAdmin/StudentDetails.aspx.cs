    ...
    public partial class StudentDetails : BaseClass
    {
        ...
        protected void GetStudents()
        {
            ...
            if (txtfirstname.Text == "")
                objBECourseAdmin.strFirstName = DBNull.Value.ToString();
            else
                objBECourseAdmin.strFirstName = txtfirstname.Text;
            if (txtlastname.Text == "")
                objBECourseAdmin.strLastName = DBNull.Value.ToString();
            else
                objBECourseAdmin.strLastName = txtlastname.Text;
            // objBEAdmin.strLastName = txtlastname.Text;
            if (txtemail.Text == "")
                objBECourseAdmin.strEmailAddress = DBNull.Value.ToString();
            else
                objBECourseAdmin.strEmailAddress = txtemail.Text;

            // objBEAdmin.strEmailAddress = txtemail.Text;
            new BCourseAdmin().BGetStudentsDetails(objBECourseAdmin);
