<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AppointmentDetails.aspx.cs" Inherits="SecureProctor.Admin.AppointmentDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">

        

         <div class="heading_menu"><a href="AdminReports.aspx">Reports </a> <img src="../Images/arrowRight.png " width="18" /> <asp:Label ID="lblAppHeader" runat="server" Text=""></asp:Label>
         </div>
        <%-- <div class="note">
