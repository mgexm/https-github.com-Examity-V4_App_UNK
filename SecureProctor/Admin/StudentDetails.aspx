<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="StudentDetails.aspx.cs" Inherits="SecureProctor.Admin.StudentDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function openAddEnrollment(ID) {
            radopen("AddEnrollment.aspx?StudentID=" + ID, "Add Enrollment", 550, 400);
        }
    ...
    <table width="100%" cellpadding="2" cellspacing="2">
        ...
        <tr id="trGridView" runat="server">
            <td>
                  <telerik:RadGrid ID="gvStudents" runat="server" 
                                AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" Skin="<%$ Resources:AppConfigurations,Skin_Current %>"
                                CellSpacing="0" GridLines="None" AllowFilteringByColumn="false" OnItemCommand="gvStudents_ItemCommand" OnPreRender="gvStudents_PreRender" OnNeedDataSource="gvStudents_NeedDataSource"  >
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="<%$ Resources:AppControls,Admin_Students_GridHeader_Actions %>"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="BtnReset" runat="server" Text="Reset" ImageUrl="~/Images/ImgReset.png"
                                                    ...
                                                    OnClientClick='<%# Eval("StudentID", "openResetStudent({0});return false;") %>' Visible="false" />
                                            </ItemTemplate>
                                                                ...
                                                                <telerik:RadGrid ID="gvEnrollments" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="10"
                                                                    ...
                                                                    <MasterTableView AllowFilteringByColumn="false" FilterItemStyle-BackColor="#DCEDFD"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <telerik:GridTemplateColumn HeaderText="<%$ Resources:AppControls,Admin_Students_GridHeader_Action %>"
                                                                                HeaderStyle-HorizontalAlign="Center" AllowFiltering="false">
                                                                                <ItemTemplate>
                                                                                    <asp:ImageButton ID="BtnEdit" runat="server" Text="Edit" ImageUrl="~/Images/edit_s.gif" ToolTip="Edit Enrollment"
                                                                                        CommandArgument='<%#Eval("EnrollmentID") %>' OnClientClick='<%# Eval("EnrollmentID", "openEditEnrollment({0});return false;") %>'>
                                                                                    </asp:ImageButton>&nbsp;&nbsp;
                                                                                    <asp:ImageButton ID="BtnDelete" runat="server" Text="Delete" ImageUrl="~/Images/delete_s.gif" ToolTip="Delete Enrollment"
                                                                                        CommandArgument='<%#Eval("EnrollmentID") %>' OnClientClick='<%# Eval("EnrollmentID", "openDeleteEnrollment({0});return false;") %>'>
                                                                                    </asp:ImageButton>
                                                                                </ItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Center" Width="15%" />
                                                                                <HeaderStyle Font-Bold="true" />
