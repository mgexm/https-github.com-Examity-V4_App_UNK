<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteExam.aspx.cs" Inherits="SecureProctor.Admin.DeleteExam" %>
    ...
    <table cellpadding="5" cellspacing="5" width="100%">
        <tr>
            <td>
                    ...
                    <%=Resources.AppControls.Admin_DeleteExam_Label_DeleteExam%></div>
            </td>
        </tr>
                    ...
                    <table cellpadding="0" cellspacing="2" width="100%" border="0">
                        <tr class="gridviewRowstyle">
                            <td width="40%" class="PopupLable">
                                <strong>
                                    <asp:Label ID="lblExam" runat="server" Text="<%$ Resources:AppControls,Admin_DeleteExam_Label_ExamName %>"></asp:Label></strong>
                            </td>
                        ...
                        <tr class="gridviewAlternatestyle">
                            <td class="PopupLable">
                                <strong>
                                    <asp:Label ID="lblStatus" Text="<%$ Resources:AppControls,Admin_DeleteExam_Label_ExamStatus %>"
                        ...
                        <tr class="gridviewRowstyle" id="trUpdate" runat="server">
                            <td class="PopupButtons1" valign="middle" colspan="3">
                                <telerik:RadButton ID="btnSave" runat="server" Text="<%$ Resources:AppControls,Admin_DeleteExam_Button_Delete %>"
                                    Skin="<%$ Resources:AppConfigurations,Skin_Current %>" OnClick="btnSave_Click">
                                </telerik:RadButton>
                                <telerik:RadButton ID="btnCancel" runat="server" Text="<%$ Resources:AppControls,Admin_DeleteExam_Button_Cancel %>"
