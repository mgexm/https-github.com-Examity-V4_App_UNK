<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="QuestionSummaries.aspx.cs" Inherits="SecureProctor.Admin.QuestionSummaries" %>
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
     <div class="container">
        <div class="container_inner">
              <div class="heading_menu">
                    <a href="AdminReports.aspx">Reports</a> <img src="../Images/arrowRight.png" width="18" /> Survey Graph
                </div>
