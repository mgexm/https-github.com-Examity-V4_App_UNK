<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStudent.aspx.cs" Inherits="SecureProctor.CourseAdmin.AddStudent" %>
                    ...
                    <div class="login_new1">
                        <table cellpadding="0" cellspacing="2" width="100%" border="0">
                            ...
                            <tr class="gridviewRowstyle">
                                ...
                                <td align="left">
                                    <telerik:RadComboBox ID="ddlprovider" runat="server" Width="200" Height="140" AutoPostBack="true" Filter="Contains" MarkFirstMatch="true"
                                        EmptyMessage="Select Instructor" DataTextField="Name" DataValueField="ExamProviderID" OnSelectedIndexChanged="ddlprovider_SelectedIndexChanged">
                                    </telerik:RadComboBox>
                                    <br />
                    ...
                    <div class="login_new1">
                        <table cellpadding="0" cellspacing="2" width="100%" border="0">
                            ...
                            <td align="left">
                                ...
                                <br />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="<%$ Resources:AppMessages,Admin_AddStudent_Error_UserID%>"
                            ...
                            <tr class="gridviewAlternatestyle">
                                ...
                                <td align="left" width="70%">
                                    <telerik:RadComboBox ID="ddlprovider1" runat="server" Width="200" Height="100" AutoPostBack="true" Filter="Contains" MarkFirstMatch="true"
                                        EmptyMessage="Select Instructor" DataTextField="Name" DataValueField="ExamProviderID" OnSelectedIndexChanged="ddlprovider1_SelectedIndexChanged">
                                    </telerik:RadComboBox>
                                    <br />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Please select Instructor"
                                        ControlToValidate="ddlprovider1" ForeColor="Red" Font-Bold="true" Font-Size="X-Small"
