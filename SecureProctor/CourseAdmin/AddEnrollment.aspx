<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEnrollment.aspx.cs" Inherits="SecureProctor.CourseAdmin.AddEnrollment" %>
                ...
                <div class="login_new1">
                    <table cellpadding="0" cellspacing="2" width="100%" border="0">
                        ...
                        <tr class="gridviewAlternatestyle">
                            ...
                            <td align="left">
                                <telerik:RadComboBox ID="ddlprovider" runat="server" AppendDataBoundItems="True" Skin="<%$ Resources:AppConfigurations,Skin_Current %>" Filter="Contains" MarkFirstMatch="true"
                                    OnSelectedIndexChanged="ddlProviderName_SelectedIndexChanged" AutoPostBack="true" >
                                </telerik:RadComboBox>
                            ...
                            <td align="left">
                                <telerik:RadComboBox ID="ddlCourse" runat="server" AppendDataBoundItems="True" Skin="<%$ Resources:AppConfigurations,Skin_Current %>" Filter="Contains" MarkFirstMatch="true">
                                 ...
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" InitialValue="--Select Course--"
                                                ErrorMessage="Please select course name" ControlToValidate="ddlCourse" ForeColor="Red" Display="Dynamic" ValidationGroup="btnAdd">
                        ...
                        <tr class="gridviewRowstyle" id="trUpdate" runat="server">
                            ...
                            <td class="PopupButtons">
                                <telerik:RadButton ID="btnAdd" runat="server" Text="<%$ Resources:AppControls,Provider_AddEnrollment_Button_Save %>"
                                    Skin="<%$ Resources:AppConfigurations,Skin_Current %>" OnClick="btnAdd_Click" ValidationGroup="btnAdd">
                                </telerik:RadButton>
