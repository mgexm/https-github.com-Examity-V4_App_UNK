<%@ Page Title="" Language="C#" MasterPageFile="~/Provider/Provider.Master" AutoEventWireup="true" CodeBehind="MyProfile.aspx.cs" Inherits="SecureProctor.Provider.MyProfile" %>
        ...
        <tr>
           ...
           <%-- <td width="25%" rowspan="3" valign="top" class="help_text_i">
                <div class="help_text_i_inner">
                    <ul>
                        <li>instructor can change the password by providing old and new password.</li><br />
                    </ul>
