<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddExam.aspx.cs" Inherits="SecureProctor.Admin.AddExam" %>
...
<head id="Head1" runat="server">
  ...
  <%--  <script type="text/javascript">
        function pageLoad() {
            $find('ExamStartRadDatePicker').get_dateInput().set_textBoxValue('MM/DD/YYYY');
            $find('ExamEndRadDatePicker').get_dateInput().set_textBoxValue('MM/DD/YYYY');
...
<body>
                    ...
                    <div class="login_new1">
                        <table cellpadding="0" cellspacing="2" width="100%" border="0">
                            ...
                            <%--<tr class="gridviewAlternatestyle">
                                ...
                                <td align="left">
                                    <telerik:RadDateTimePicker ID="CalendarExtender1" runat="server"  DateInput-ReadOnly="false"  Skin="<%$ Resources:AppConfigurations,Skin_Current %>">
                            ...
                            <tr class="gridviewAlternatestyle">
                                ...
                                <td align="left">
                                    ...
                                    <telerik:RadTimePicker ID="ExamStartRadTimePicker" runat="server" DateInput-ReadOnly="true" Width="90px" Skin="Web20" Columns="6">
                                        <TimeView ID="TimeView1" Interval="00:30:00" Width="420px" Columns="6" runat="server"></TimeView> 
                            ...
                            <tr class="gridviewRowstyle">
                                ...
                                <td>
                                    ...
                                    <telerik:RadTimePicker ID="ExamEndRadTimePicker" runat="server" TimeView-StartTime="00:00:00" TimeView-EndTime="23:59:59" DateInput-ReadOnly="true" Width="90px" Skin="Web20" Columns="6">
                            ...
                            <%--  <tr class="gridviewRowstyle">
                                ...
                                <td align="left">
                                    <telerik:RadDateTimePicker ID="CalendarExtender2" runat="server" DateInput-ReadOnly="false" SharedTimeViewID="ExamEndTime" Skin="<%$ Resources:AppConfigurations,Skin_Current %>">
 ...
 <telerik:RadAsyncUpload runat="server"  ID="AdminUpload" Width="200px" MultipleFileSelection="Automatic"   UploadedFilesRendering="BelowFileInput"  AllowedFileExtensions="jpg,jpeg,png,gif,doc,docx,xlsx,xls,txt,pdf" MaxUploadSize="10000000">
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="lblEUserName" Text="Exam UserName" runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
                                        ...
                                        <ContentTemplate>
                                            <telerik:RadGrid ID="gvAllowed" runat="server"
                                                ...
                                                <MasterTableView AllowFilteringByColumn="false" FilterItemStyle-BackColor="#DCEDFD"
                                                    ...
                                                    <Columns>
                                                         <telerik:GridBoundColumn DataField="RuleID" HeaderText="Additional Rules"
                                                            UniqueName="RuleID" HeaderStyle-HorizontalAlign="Left" AllowSorting="false" Visible="false">
                                                        ...
                                                        <telerik:GridTemplateColumn>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="ChkProctor" runat="server" Checked='<%# Convert.ToBoolean(Eval("Status")) %>'  CausesValidation="false" />
                                                                    <%-- OnCheckedChanged="ChkAdditionalRule_CheckedChanged" --%>
                                                            </ItemTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-ForeColor="Black" HeaderStyle-BackColor="White" HeaderStyle-Width="0px"
                            ...
                            <tr class="gridviewAlternatestyle">
                                <td class="PopupLable">
                                    <strong>
                                        <asp:Label ID="Label8" Text="Exam UserName"
                                            runat="server"></asp:Label></strong>:
                                </td>
                                <td align="left">
