<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AppointmentScheduleReport.aspx.cs" Inherits="SecureProctor.Admin.AppointmentScheduleReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
    ...
    <div class="heading_menu"><a href="AdminReports.aspx">Reports</a> <img src="../Images/arrowRight.png " width="18" /> Schedule details</div>
<%--    <div class="note">
        ...
        <tr id="trGridView" runat="server">
            <td>
                <telerik:RadGrid ID="gvReports" runat="server" OnNeedDataSource="gvReports_NeedDataSource"   OnPageIndexChanged="gvReports_PageIndexChanged"                   
                    AllowPaging="True" AllowSorting="True" Skin="Web20" CellSpacing="0" GridLines="None"  PageSize="50" AutoGenerateColumns="false" OnItemCommand="gvReports_ItemCommand" OnPageSizeChanged="gvReports_PageSizeChanged">
