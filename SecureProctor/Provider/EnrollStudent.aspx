<%@ Page Title="" Language="C#" MasterPageFile="~/Provider/Provider.Master" AutoEventWireup="true"
    CodeBehind="EnrollStudent.aspx.cs" Inherits="SecureProctor.Provider.EnrollStudent" %>
                                                ...
                                                <tr class="gridviewRowstyle">
                                                    ...
                                                    <td width="75%" align="left" style="height:35px;">
                                                        <telerik:RadComboBox ID="ddlStudents" runat="server" AppendDataBoundItems="True"
                                                            Skin="Web20" DropDownAutoWidth="Enabled"  Filter="Contains" MarkFirstMatch="true">
                                                        </telerik:RadComboBox>
                                                    </td>
                                                </tr>
                                                <tr class="gridviewAlternatestyle" style="height:35px;">
                                                    ...
                                                    <td width="75%" align="left">
                                                        <telerik:RadComboBox ID="ddlCourse" runat="server" AppendDataBoundItems="True" Skin="Web20"
                                                            Width="250" DropDownAutoWidth="Enabled"  Filter="Contains" MarkFirstMatch="true">
                                                        </telerik:RadComboBox>
                                                    </td>
                                                </tr>
