...
namespace SecureProctor.Provider
{
    public partial class AddExam : BaseClass
    {
        ...
        protected void BindDropDowns()
        {
            ...
            ddlMinutes.DataBind();
            //rcbHours.DataSource = dtHrs;
            //rcbHours.DataTextField = "Hrs";
            //rcbHours.DataValueField = "Hrs";
            //rcbHours.DataBind();
            //rcbMinutes.DataSource = dtMin;
            //rcbMinutes.DataTextField = "Min";
            //rcbMinutes.DataValueField = "Min";
            //rcbMinutes.DataBind();
            //radHours.DataSource = dtHrs;
            //radHours.DataTextField = "Hrs";
            //radHours.DataValueField = "Hrs";
            //radHours.DataBind();
            //radMinutes.DataSource = dtMin;
            //radMinutes.DataTextField = "Min";
            //radMinutes.DataValueField = "Min";
            //radMinutes.DataBind();
        }
            ...
            try
            {
                if (Page.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        //if (objBEExamProvider.DsResult != null && objBEExamProvider.DsResult.Tables[0].Rows.Count > 0)
                        //{
                        //    ViewState["DT_Rules"]= objBEExamProvider.DsResult.Tables[0];
                        //    //gvRulesConfirm.DataSource = objBEExamProvider.DsResult.Tables[0];
                        //}
                        //if (objBEExamProvider.DsResult != null && objBEExamProvider.DsResult.Tables[1].Rows.Count > 0)
                        //{
                        //    //gvnotesConfirm.DataSource = objBEExamProvider.DsResult.Tables[1];
                        //    ViewState["DT_Notes"]= objBEExamProvider.DsResult.Tables[1];
                        //}
                        //gvRulesConfirm.Rebind();
                        //gvnotesConfirm.Rebind();
