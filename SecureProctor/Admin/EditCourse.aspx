<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCourse.aspx.cs" Inherits="SecureProctor.Admin.EditCourse" %>
    ...
    <table cellpadding="5" cellspacing="5" width="100%">
        <tr>
            <td>
                    ...
                    <%=Resources.AppControls.Admin_EditCourse_Label_EditCourse%></div>
            </td>
        </tr>
        <tr>
            <td>
                <div class="login_new1">
                    <table cellpadding="0" cellspacing="2" width="100%" border="0">
                        ...
                        <tr id="trCourseEdit" runat="server">
                            <td align="center" colspan="2">
                                <table width="100%" cellpadding="0" cellspacing="2">
                                    <tr class="gridviewAlternatestyle">
                                        <td class="PopupLable" width="30%">
                                           <strong><%= Resources.AppControls.Admin_EditCourse_Label_CourseID%></strong>
                                        </td>
                                        <td align="left" width="70%">
                                            <asp:TextBox ID="TxtCourseID" runat="server" Width="150" MaxLength="50"></asp:TextBox>
                                            </br>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$ Resources:AppMessages,Admin_EditCourse_Error_CourseID %>"
                                    ...
                                    <tr class="gridviewRowstyle">
                                        <td class="PopupLable">
                                            <strong>
                                                <%= Resources.AppControls.Admin_EditCourse_Label_CourseName%></strong>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtCourseName" runat="server" Width="300" MaxLength="100"></asp:TextBox>                                           
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<%$ Resources:AppMessages,Admin_EditCourse_Error_CourseName %>"
                                    ...
                                    <tr class="gridviewAlternatestyle">
                                        <td class="PopupLable">
                                             <strong>
                                                <%= Resources.AppControls.Admin_EditCourse_Label_Status%></strong>
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr class="gridviewRowstyle">
                                        <td class="PopupLable">
                                             <strong>
                                                <%= Resources.AppControls.Admin_EditCourse_Label_CreatedDate %></strong>
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr class="gridviewAlternatestyle">
                                        <td class="PopupLable">
                                            <strong>
                                                <%= Resources.AppControls.Admin_EditCourse_Label_ModifiedDate%></strong>
                                        </td>
                                        <td align="left">
                        ...
                        <tr id="trCourseView" runat="server">
                            <td align="center" colspan="2">
                                <table width="100%" cellpadding="0" cellspacing="2">
                                    <tr class="gridviewAlternatestyle">
                                        <td class="PopupLable" width="30%">
                                    ...
                                    <tr class="gridviewRowstyle">
                                        <td class="PopupLable">
                                           <strong><%= Resources.AppControls.Admin_EditCourse_Label_CourseName%></strong>
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr class="gridviewAlternatestyle">
                                        <td class="PopupLable">
                                            <strong><%= Resources.AppControls.Admin_EditCourse_Label_Status%></strong>
                                        </td>
                                        <td align="left">                                           
                                    ...
                                    <tr class="gridviewRowstyle">
                                        <td class="PopupLable">
                                          <strong><%= Resources.AppControls.Admin_EditCourse_Label_CreatedDate%></strong>
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr class="gridviewAlternatestyle">
                                        <td class="PopupLable">
                                            <strong><%= Resources.AppControls.Admin_EditCourse_Label_ModifiedDate%></strong>
                                        </td>
                                        <td align="left">
