<%@ Page Title="" Language="C#" MasterPageFile="~/CourseAdmin/CourseAdmin.Master" AutoEventWireup="true" CodeBehind="ViewUserDetails.aspx.cs" Inherits="SecureProctor.CourseAdmin.ViewUserDetails" %>
                                                                    ...
                                                                    <td>
                                                                        <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                            <tr class="gridviewHeaderstyle">
                                                                                <td align="left" colspan="4" style="line-height: 35px;">&nbsp;&nbsp;&nbsp;<strong>Student Profile</strong>
                                                                                </td>
                                                                            </tr>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <telerik:RadGrid ID="gvStudentExamStatus" runat="server" OnNeedDataSource="gvStudentExamStatus_NeedDataSource"
                                                    ...
                                                    GridLines="None" Skin="<%$ Resources:SecureProctor,Telerik_Grid_Skin %>" OnItemDataBound="gvStudentExamStatus_ItemDataBound" OnItemCommand="gvStudentExamStatus_ItemCommand" OnSortCommand="gvStudentExamStatus_SortCommand">
                                                    ...
                                                    <MasterTableView AllowFilteringByColumn="true" FilterItemStyle-BackColor="#DCEDFD" AllowNaturalSort="false">
                                                        <Columns>
                                                            ...
                                                            <telerik:GridBoundColumn DataField="CourseName" HeaderText="<%$ Resources:SecureProctor,Grid_Header_CourseName %>"
                                                                SortExpression="CourseName" UniqueName="CourseName" HeaderStyle-HorizontalAlign="Center" FilterControlWidth="60%">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle Font-Bold="true" />
                                                            </telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn DataField="ExamName" HeaderText="<%$ Resources:SecureProctor,Grid_Header_ExamName %>"
                                                                SortExpression="ExamName" UniqueName="ExamName" HeaderStyle-HorizontalAlign="Center" FilterControlWidth="60%">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <HeaderStyle Font-Bold="true" />
                                                            </telerik:GridBoundColumn>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="<%$ Resources:SecureProctor,Grid_Header_View %>"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkView" runat="server" Text="<%$ Resources:SecureProctor,Grid_Header_View %>" CommandArgument='<%# Eval("TransID")%>'
                                                                        Font-Underline="true" ForeColor="Blue" Visible="false" CommandName="view"></asp:LinkButton>
