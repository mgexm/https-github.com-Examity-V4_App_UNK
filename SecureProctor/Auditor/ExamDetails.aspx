<%@ Page Language="C#" MasterPageFile="~/Auditor/Auditor1.Master" AutoEventWireup="true"
    CodeBehind="ExamDetails.aspx.cs" Inherits="SecureProctor.Auditor.ExamDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AuditorContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenEditComments(ID) {
            radopen("EditComments.aspx?CommentID=" + ID, "Edit Comments", 700, 450);
        }
                                        ...
                                        <table width="100%" cellpadding="1" cellspacing="1">
                                            ...
                                            <tr>
                                                <td align="left" valign="middle">
                                                    <br />
                                                    <telerik:RadButton ID="btnDeleteAlerts" runat="server" Text="Delete Flags" Skin="Web20" Width="150"
                                                        OnClick="btnDeleteAlerts_Click">
                                                    </telerik:RadButton>
                                                </td>
                                            </tr>
                                            <tr>
