    ...
    public partial class TestResultReport :BaseClass
    {
        ...
        public void GenerateReport()
        {
            ...
            if (gvReports.Items.Count > 0)
            {
                ...
                Response.AppendHeader("Content-Disposition", "attachment; filename=" + "Exam status" + DateTime.Now.ToString("MM/dd/yyyy HH:mm:ss").Replace("/", "-") + ".xlsx");
        ...
        public void SendEmail()
        {
            ...
            ExcelSheetGenerator objExcel = new ExcelSheetGenerator();
            objExcel.GenerateReport(objDt, rptFileName, "Exam status _", "UserName");
            ...
            body.Append(@"<tr><td>Hi,<br/><br/>Please find the enclosed Exam status summary.
