<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.Master" AutoEventWireup="true" CodeBehind="ExamUploadFiles.aspx.cs" Inherits="SecureProctor.Student.ExamUploadFiles" %>
            ...
            <table cellpadding="2" cellspacing="2" width="100%">
                <tr>
                    <td>
                        ...
                        <asp:Image ID="imgHead" runat="server" ImageUrl="../images/ImgUploadfiles.png" AlternateText="Upload Files" title="Upload Files" TabIndex="11" />
                    </td>
                ...
                <tr>
                    <td width="70%" align="center" valign="top">
                        <div class="login_new1">
                            <telerik:RadGrid ID="gvStudentHome" runat="server" OnNeedDataSource="gvStudentHome_NeedDataSource"
                                ...
                                <MasterTableView AllowFilteringByColumn="false" FilterItemStyle-BackColor="#DCEDFD">
                                    <Columns>
                                        <telerik:GridTemplateColumn HeaderText="<%$ Resources:SecureProctor,Grid_Header_ExamID %>"
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkTransID" runat="server" Text='<%# Bind("TransID")%>' CommandArgument='<%#Bind("TransID")%>'
                                                    Font-Underline="true" CommandName="ExamID" CssClass="GridLink"></asp:LinkButton>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            <HeaderStyle Font-Bold="true" />
                                        </telerik:GridTemplateColumn>
                                         <telerik:GridBoundColumn DataField="CourseName" HeaderText="<%$ Resources:SecureProctor,Grid_Header_CourseName %>"
                                            SortExpression="CourseName" UniqueName="CourseName" ItemStyle-CssClass="itemNameColumn" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Center" Width="20%" />
                                            <HeaderStyle Font-Bold="true" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="ExamName" HeaderText="<%$ Resources:SecureProctor,Grid_Header_ExamName %>"
                                            SortExpression="ExamName" UniqueName="ExamName" ItemStyle-CssClass="itemNameColumn" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle HorizontalAlign="Center" Width="20%" />
                                            <HeaderStyle Font-Bold="true" />
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="<%$ Resources:SecureProctor,Grid_Header_ReschduleORCancel %>"
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkReschdule" runat="server" Text="<%$ Resources:SecureProctor,Grid_Header_ReschduleORCancel %>"
                                                    CommandArgument='<%#Bind("ExamDate")%>' Font-Underline="true" CommandName="Reschdule"
                                                    Visible="false"></asp:LinkButton>
                                                <asp:Label ID="lblReschdule" runat="server" Visible="false" Text="<%$ Resources:SecureProctor,Grid_Header_ReschduleORCancel %>"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            <HeaderStyle Font-Bold="true" />
                                        </telerik:GridTemplateColumn>
