<%@ Page Title="" Language="C#" MasterPageFile="~/Provider/Provider.Master" AutoEventWireup="true" CodeBehind="TestResultReport.aspx.cs" Inherits="SecureProctor.Provider.TestResultReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ExamProviderContent" runat="server">
  <script type="text/javascript">
     ...
     <div class="heading_menu"><a href="Reports.aspx">Reports</a> <img src="../Images/arrowRight.png " width="18" /> Exam status</div>
        ...
        <table width="100%" cellpadding="2" cellspacing="2">
            ...
            <telerik:RadDatePicker  DateInput-ReadOnly="true" ID="txtToDate" runat="server" Width="120" Skin="Web20">
                ...
                <telerik:RadGrid ID="gvReports" runat="server"  OnNeedDataSource="gvReports_NeedDataSource" OnPageIndexChanged="gvReports_PageIndexChanged"                   
                    AllowPaging="True" AllowSorting="true" Skin="Web20" GridLines="None"  PageSize="6" AutoGenerateColumns="false" OnPageSizeChanged="gvReports_PageSizeChanged">
