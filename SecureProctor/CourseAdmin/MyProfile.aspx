<%@ Page Title="" Language="C#" MasterPageFile="~/CourseAdmin/CourseAdmin.Master" AutoEventWireup="true" CodeBehind="MyProfile.aspx.cs" Inherits="SecureProctor.CourseAdmin.MyProfile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ExamProviderContent" runat="server">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="8" class="td_bg">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <telerik:RadTextBox ID="txtLastName" runat="server" Visible="false"></telerik:RadTextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                                ErrorMessage="<%$ Resources:ResMessages,Reg_LastName %>" ControlToValidate="txtLastName" ForeColor="Red"
                                                ValidationGroup="Edit">
                                            </asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <telerik:RadTextBox ID="txtEmail" runat="server" Visible="false" Width="320"></telerik:RadTextBox>
                                       ...
                                       <td>
                                        ...
                                        <td align="left">
                                            ...
                                            <telerik:RadComboBox ID="ddlTimeZone" runat="server" Width="320" AppendDataBoundItems="true" Visible="false"
                                                Skin="<%$ Resources:SecureProctor,Telerik_ComboBox_Skin %>" OnItemDataBound="ddlTimeZone_ItemDataBound">
                                                <Items>
  ...
  <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" Display="Dynamic"
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" Display="Dynamic" ValidationGroup="Edit"
                                                ForeColor="Red" runat="server" ControlToValidate="txtEmail" ErrorMessage="<%$ Resources:ResMessages,Provider_UserValidemail %>"
        ...
        <tr id="trChangePassword" runat="server">
          ...
          <%--  <td width="25%" rowspan="3" valign="top" class="help_text_i">
                <div class="help_text_i_inner">
                    <ul>
                        <li>instructor can change the password by providing old and new password.</li>
                        <br />
                    </ul>
