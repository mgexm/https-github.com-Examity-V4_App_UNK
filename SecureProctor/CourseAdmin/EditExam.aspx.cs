        ...
        protected void BtnUpdateExam_Click(object sender, EventArgs e)
        {
            try
            {
                if (Page.IsValid)
                {
                    ...
                    lblExamUserName.Text = txtExamUserName.Text;
                    ...
                    //objBEExamProvider.strExamStartDate = Convert.ToDateTime(calStartDate.SelectedDate.ToString());
                    //lblConfirmStartDateValue.Text = DateTime.Parse(calStartDate.SelectedDate.ToString()).ToShortDateString();
                    // objBEExamProvider.strExamEndDate = Convert.ToDateTime(calEndDate.SelectedDate.ToString());
                    //lblConfirmEndDateValue.Text = DateTime.Parse(calEndDate.SelectedDate.ToString()).ToShortDateString();
                    ...
                    //objBEExamProvider.strExamStartDate = calStartDate.SelectedDate.Value.AddMinutes(TimeDelay);
                    //objBEExamProvider.strExamEndDate = calEndDate.SelectedDate.Value.AddMinutes(TimeDelay);
       ...
       */
        ...
        protected void getSelectedExamDetails()
        {
            try
            {
                ...
                if (objBECourseAdmin.DsResult != null)
                {
                    ...
                    txtExamUserName.Text = objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamUserName"].ToString();
                    txtExamPassword.Text = objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamPassword"].ToString();
                    txtExam.Text = objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamName"].ToString();
                    ddlSecurityLevel.SelectedValue = objBECourseAdmin.DsResult.Tables[0].Rows[0]["ID"].ToString();
                    lblLevelDesc.Text = objBECourseAdmin.DsResult.Tables[0].Rows[0]["Description"].ToString();
                    ...
                    if (objBECourseAdmin.DsResult.Tables[0].Rows[0]["StudentUploadFile"].ToString() == "Yes")
                    {
                    ...
                    ddlExamFeePaidBy.SelectedValue = objBECourseAdmin.DsResult.Tables[0].Rows[0]["PaidBy_ExamFee"].ToString();
                    ddlOnDemandFeePaidBy.SelectedValue = objBECourseAdmin.DsResult.Tables[0].Rows[0]["PaidBy_OnDemandFee"].ToString();

                    txtAccessExam.InnerText = objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamLink"].ToString();
                    if (objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamStartDate"].ToString() != null && objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamStartDate"].ToString() != "--" && objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamStartDate"].ToString() != "")
                    {
                        DateTime examstartdate = Convert.ToDateTime(objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamStartDate"]);
                        DateTime examstarttime = Convert.ToDateTime(objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamStartDate"]);
                       ...
                       // calStartDate.SelectedDate = Convert.ToDateTime(objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamStartDate"].ToString());
                    }

                    if (objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamEndDate"].ToString() != null && objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamEndDate"].ToString() != "--" && objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamEndDate"].ToString() != "")
                    {
                        DateTime examenddate = Convert.ToDateTime(objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamEndDate"]);
                        DateTime examendtime = Convert.ToDateTime(objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamEndDate"]);
                        ...
                        //calEndDate.SelectedDate = Convert.ToDateTime(objBECourseAdmin.DsResult.Tables[0].Rows[0]["ExamEndDate"].ToString());
                    }
                    ddlStatus.Items.FindItemByText(objBECourseAdmin.DsResult.Tables[0].Rows[0]["status"].ToString()).Selected = true;
                    ...
                    if (objBECourseAdmin.DsResult.Tables[1].Rows.Count > 0)
                    {

                        gvStandard.DataSource = objBECourseAdmin.DsResult.Tables[1];
                        gvStandard.DataBind();
                    ...
                    if (objBECourseAdmin.DsResult.Tables[2].Rows.Count > 0)
                    {
                        // ViewState["DT_Notes"] = objBEExamProvider.DsResult.Tables[2];
                        ViewState["ADDITIONALRULE"] = objBECourseAdmin.DsResult.Tables[2];
                        ViewState["ADDITIONALRULE_OLD"] = objBECourseAdmin.DsResult.Tables[2];
                        gvAllowed.DataSource = objBECourseAdmin.DsResult.Tables[2];
                        gvAllowed.DataBind();
                    ...
                    if (objBECourseAdmin.DsResult.Tables[3].Rows.Count > 0)
                    {
                        ViewState["SPECIALRULE"] = objBECourseAdmin.DsResult.Tables[3];
                        gvSpecial.DataSource = objBECourseAdmin.DsResult.Tables[3];
                        gvSpecial.DataBind();
        ...
        protected void BindProviderSecurityLevel()
        {
            try
            {
                BECourseAdmin objBECourseAdmin = new BECourseAdmin();
                BCourseAdmin objBCourseAdmin = new BCourseAdmin();
                objBCourseAdmin.BBindProviderSecurityLevel(objBECourseAdmin);
