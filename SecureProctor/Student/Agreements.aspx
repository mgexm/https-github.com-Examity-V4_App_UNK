<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.Master" AutoEventWireup="true" CodeBehind="Agreements.aspx.cs" Inherits="SecureProctor.Student.Agreements" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="StudentContent" runat="server">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td>
                <h1 style="padding: 10px; color: #666;">Confirm Agreement</h1>
            </td>
        </tr>
        <tr>
            <td>
                            ...
                            <tr>
                                <td align="center" class="AAStep_shadow" valign="top">
                                    <div class="AAStep_shadow_inner">
                                        <div class="AAstepsID4" style="width: 800px; margin: 0px auto;"></div>
                                        <table cellpadding="2" cellspacing="2" width="100%">
                                            <tr>
                                                                            ...
                                                                            <td colspan="2">
                                                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td width="20%" valign="top"  style="border-right: 1px solid #4e75b3; border-bottom: 1px solid #4e75b3; background: #fff;" >
                                                                                            <table width="100%"cellpadding="0" cellspacing="0">
                                                                                                <tr>
