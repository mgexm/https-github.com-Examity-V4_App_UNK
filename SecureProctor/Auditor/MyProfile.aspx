<%@ Page Title="" Language="C#" MasterPageFile="~/Auditor/Auditor.Master" AutoEventWireup="true"
    CodeBehind="MyProfile.aspx.cs" Inherits="SecureProctor.Auditor.MyProfile" %>
        ...
        <tr>
                            ...
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="8" class="td_bg">
                                    <tr class="td_header">
                                        <td colspan="4" align="left">
                                            <table width="100%">
                                                <tr>
                                                    <td align="left" class="boreder_home_pro">
                                                        <asp:Image ID="Image4" runat="server" ImageUrl="~/Images/cp.png" />
                                                    </td>
                                                    <%--<td align="right"><asp:Image ID="Image8" runat="server" ImageUrl="~/Images/edit.png" /> &nbsp;&nbsp;&nbsp;</td>--%></tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%--<asp:TextBox ID="txtCurrentPassword" runat="server" TextMode="Password" CssClass="td_input"></asp:TextBox>--%>
                                            <telerik:RadTextBox ID="txtCurrentPassword" runat="server" TextMode="Password" CssClass="td_input"
                                                Width="250">
                                            </telerik:RadTextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%--<asp:TextBox ID="txtNewPassword" runat="server" TextMode="Password" CssClass="td_input"></asp:TextBox>--%>
                                            <telerik:RadTextBox ID="txtNewPassword" runat="server" TextMode="Password" CssClass="td_input"
                                                Width="250">
                                            </telerik:RadTextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%--<asp:TextBox ID="txtConfirmNewPassword" runat="server" TextMode="Password" CssClass="td_input"></asp:TextBox>--%>
                                            <telerik:RadTextBox ID="txtConfirmNewPassword" runat="server" TextMode="Password"
                                                CssClass="td_input" Width="250">
                                            </telerik:RadTextBox>
           ...
           <%-- <td width="25%" rowspan="3" valign="top" class="help_text_i">
                <div class="help_text_i_inner">
                    <ul>
                        <li>Auditor can change the password by providing old and new password.</li><br />
                    </ul>
