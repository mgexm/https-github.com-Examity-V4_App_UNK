...
{
    public partial class AutoProctorConfirmation : BaseClass
    {
        ...
        protected void back_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AutoExamDetails.aspx?TransID=" + AppSecurity.Encrypt(ViewState[BaseClass.EnumPageSessions.TransID].ToString()), false);
        }
