<%@ Page Title="" Language="C#" MasterPageFile="~/CourseAdmin/CourseAdmin.Master" AutoEventWireup="true" CodeBehind="ExamDetails.aspx.cs" Inherits="SecureProctor.CourseAdmin.ExamDetails" %>
                    ...
                    <table width="100%" cellpadding="2" cellspacing="4">
                            ...
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0" class="td_bg">
                                    ...
                                    <tr class="gridviewAlternatestyle">
                                        ...
                                        <td align="left" valign="top">
                                            <asp:UpdatePanel ID="upNotes1" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                    ...
                                    <tr class="gridviewAlternatestyle">
                                        ...
                                        <td align="left" valign="top">
                                            <asp:UpdatePanel ID="upRules1" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                ...
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="BtnClearRules" EventName="Click" />
                                                </Triggers>
                                            </asp:UpdatePanel>
                                            <br />
                                        </td>
                                    ...
                                    <tr class="gridviewRowstyle">
                                        ...
                                        <td colspan="2" style="padding-top: 5px; padding-bottom: 5px;">
                                            <asp:UpdatePanel ID="upRules" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                ...
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="BtnAddRules" EventName="Click" />
                                                </Triggers>
                                            </asp:UpdatePanel>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:UpdatePanel ID="upExamDetails" runat="server">
                                    <ContentTemplate>
