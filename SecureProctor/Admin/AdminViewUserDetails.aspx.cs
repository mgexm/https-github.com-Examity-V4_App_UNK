...
{
    public partial class AdminViewUserDetails : BaseClass
    {
        ...
        protected void BindCourseDetails(int studentID)
        {
            ...
            if (objBECommon.DtResult.Rows.Count > 0)
                ...
                gvStudentExamStatus.DataSource = new object[] { };
        ...
        protected void gvStudentExamStatus_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("AdminViewExamScreens.aspx?TransID=" + AppSecurity.Encrypt(e.CommandArgument.ToString()) + "&Type=View1", false);
            }
