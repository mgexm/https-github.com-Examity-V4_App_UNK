<%@ Page Title="" Language="C#" MasterPageFile="~/Provider/Provider.Master" AutoEventWireup="true" CodeBehind="TestSummaryReport.aspx.cs" Inherits="SecureProctor.Provider.TestSummaryReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ExamProviderContent" runat="server">
    ...
    <div class="heading_menu"><a href="Reports.aspx">Reports</a> <img src="../Images/arrowRight.png " width="18" /> Schedule status </div>
  <%--  <div class="note">
         ...
         <table width="100%" cellpadding="2" cellspacing="2">
                    <tr>
                        ...
                        <td align="left"  width="15%"  valign="top"><telerik:RadComboBox ID="rcbCourses" runat="server" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" EmptyMessage="       --Select Course--       "
                            Width="150"  Localization-AllItemsCheckedString="All Courses selected" DropDownAutoWidth="Enabled"  Filter="Contains" MarkFirstMatch="true" AutoCompleteSeparator=","  AutoPostBack="true">
    ...
    Display="Dynamic" ErrorMessage="Please select a course" />
        ...
        <tr id="trGridView" runat="server">
            <td>
                <telerik:RadGrid ID="gvReports" runat="server"   OnPageIndexChanged="gvReports_PageIndexChanged"                   
                    AllowPaging="True" AllowSorting="False" Skin="Web20" CellSpacing="0" GridLines="None"   LabelCssClass="SelectClient_text" PageSize="50" AutoGenerateColumns="false"  OnPageSizeChanged="gvReports_PageSizeChanged" OnItemDataBound="gvReports_ItemDataBound">
