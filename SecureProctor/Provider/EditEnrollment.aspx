<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditEnrollment.aspx.cs"
    Inherits="SecureProctor.Provider.EditEnrollment" %>
        ...
        <tr>
            <td>
                <div class="heading customfont1">
                    <%=Resources.AppControls.Provider_EditEnrollment_Label_EditStudentExamEnrollment%></div>
            </td>
        </tr>
        <tr>
            <td>
