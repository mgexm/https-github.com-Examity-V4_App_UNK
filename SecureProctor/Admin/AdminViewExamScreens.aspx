<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AdminViewExamScreens.aspx.cs" Inherits="SecureProctor.Admin.AdminViewExamScreens" %>
                ...
                <telerik:RadGrid ID="gvexamdetails" runat="server" OnNeedDataSource="gvexamdetails_NeedDataSource"
                    ...
                    <MasterTableView>
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Examikey" HeaderText="<%$ Resources:ResMessages,MyProfile_ExamiKEY %>"
                                UniqueName="Examikey" HeaderStyle-HorizontalAlign="Center">
                                <ItemStyle HorizontalAlign="Center" />
                                <HeaderStyle Font-Bold="true" />
                            </telerik:GridBoundColumn>
                    ...
                    <ContentTemplate>
                        ...
                        <table width="100%" cellpadding="1" cellspacing="1">
                                    ...
                                    <table width="100%" align="center">
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <br />
                                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidatorddlFlags" InitialValue="--Please select--" Display="Dynamic"
                                        ...
                                        <tr>
                                         ...
                                         <td align="left" valign="top"  width="8%"><strong>Description</strong></td>
                                            ...
                                            <td align="left" valign="top">
                                                ...
                                                <telerik:RadTextBox ID="txtComments" runat="server" MaxLength="300" TextMode="MultiLine" Rows="5" Width="100%">
                                                </telerik:RadTextBox>
                                                <br />
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;<br />
                                                <div align="center">
                                                    <telerik:RadButton ID="RadButton1" runat="server" Text="Back" Skin="Web20" Width="60"
                                                        OnClick="btnBack_Click">
                                                    </telerik:RadButton>
                                                    <telerik:RadButton ID="RadButton2" runat="server" Text="<%$ Resources:SecureProctor,Common_Add %>"
                                                        Skin="Web20" Width="60" OnClick="btnAddComments_Click" ValidationGroup="submit">
                                                    </telerik:RadButton>
                                                    <telerik:RadButton ID="RadButton3" runat="server" Text="<%$ Resources:SecureProctor,Common_Clear%>"
                            ...
                            <tr>
                                <td align="center">
                                    <br />
                                    <telerik:RadButton ID="btnBack" runat="server" Text="Back" Skin="Web20" Width="80"
                                        OnClick="btnBack_Click">
                                    </telerik:RadButton>
                                    ...
                                    <telerik:RadButton ID="btnClear" runat="server" Text="<%$ Resources:SecureProctor,Common_Clear%>"
                                        Skin="Web20" Width="80" OnClick="btnClear_Click">
                                    </telerik:RadButton>--%>
                                </td>
                            </tr>
                            <tr>
