<%@ Page Title="" Language="C#" MasterPageFile="~/CourseAdmin/CourseAdmin.Master" AutoEventWireup="true" CodeBehind="ReportsView.aspx.cs" Inherits="SecureProctor.CourseAdmin.ReportsView" %>
        ...
        <tr id="trGridView" runat="server">
            <td>
                <telerik:RadGrid ID="gvReports" runat="server" OnNeedDataSource="gvReports_NeedDataSource"
                    ...
                    <ExportSettings Pdf-PageWidth="1800">
                    </ExportSettings>
                </telerik:RadGrid>
            </td>
        </tr>
