<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditEnrollment.aspx.cs" Inherits="SecureProctor.Admin.EditEnrollment" %>
    ...
    <table cellpadding="5" cellspacing="5" width="100%">
        <tr>
            <td>
                    ...
                    <%=Resources.AppControls.Admin_EditEnrollment_Label_EditStudentExamEnrollment%></div>
            </td>
        </tr>
        <tr>
                ...
                <table cellpadding="0" cellspacing="2" width="100%" border="0">
                    ...
                    <tr class="gridviewAlternatestyle">
                        <td class="PopupLable" width="30%">
                           <strong><%= Resources.AppControls.Admin_EditEnrollment_Label_StudentName%></strong>
                        </td>
                    ...
                    <tr class="gridviewRowstyle">
                        <td class="PopupLable">
                            <strong><%= Resources.AppControls.Admin_EditEnrollment_Label_EmailAddress %></strong>
                        </td>
                        <td align="left">
                    ...
                    <tr class="gridviewAlternatestyle">
                        <td class="PopupLable">
                            <strong><%= Resources.AppControls.Admin_EditEnrollment_Label_CourseName %></strong>
                        </td>
                        <td align="left">
                    ...
                    <tr class="gridviewRowstyle">
                        <td class="PopupLable">
                            <strong><%= Resources.AppControls.Admin_EditEnrollment_Label_Status %></strong>
                        </td>
                        <td align="left">
                    ...
                    <tr class="gridviewAlternatestyle">
                        ...
                        <td class="PopupButtons" valign="middle">
                            <telerik:RadButton ID="btnUpdate" runat="server" Text="<%$ Resources:AppControls,Admin_EditEnrollment_Button_Update %>"
                                Skin="<%$ Resources:AppConfigurations,Skin_Current %>" OnClick="btnUpdate_Click">
                            </telerik:RadButton>
                            <telerik:RadButton ID="btnCancel" runat="server" Text="<%$ Resources:AppControls,Admin_EditEnrollment_Button_Cancel %>"
