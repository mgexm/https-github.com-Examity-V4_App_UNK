<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditComments.aspx.cs" Inherits="SecureProctor.Auditor.EditComments" %>
                            ...
                            <tr id="trCommentsEdit" runat="server">
                                <td align="center" colspan="2">
                                   ...
                                   <tr class="gridviewRowstyle" id="DivTextBox"  >
                                        ...
                                        <tr class="gridviewRowstyle" id="trDeleteImage" runat="server">
                                            <td class="PopupLable">
                                                <strong>Alert Image :</strong>
                                            </td>
                                            <td align="left">
