<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="MyProfile.aspx.cs" Inherits="SecureProctor.Admin.MyProfile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="tdSaveTimeZone" runat="server" align="right" class="boreder_home_pro">
                                                        ...
                                                        <telerik:RadButton ID="RadButton2" runat="server" Text="<%$ Resources:SecureProctor,Common_Save %>"
                                                            ...
                                                            ValidationGroup="Edit" AutoPostBack="true">
                                                        </telerik:RadButton>
                                   ...
                                   <tr>
                                    ...
                                    <tr>--%>
                                        ...
                                        <td align="left">
                                            ...
                                            <telerik:RadComboBox ID="ddlTimeZone" runat="server" Width="320" AppendDataBoundItems="true" Filter="Contains" MarkFirstMatch="true"
        ...
        <tr id="trChangePassword" runat="server">
            <td>
                <asp:UpdatePanel ID="upChangePwd" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="pnlpwd" runat="server" DefaultButton="btnSubmit">
                            <table width="100%" cellpadding="0" cellspacing="8" class="td_bg">
                                <tr class="td_header">
                                    <td colspan="4" align="left">
                                        <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCurrentPassword" runat="server" TextMode="Password" CssClass="td_input"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNewPassword" runat="server" TextMode="Password" CssClass="td_input"
                                            BorderColor="#B8B8B8"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtConfirmNewPassword" runat="server" TextMode="Password" CssClass="td_input"
                                            BorderColor="#B8B8B8"></asp:TextBox>
   ...
   <%-- <td width="25%" rowspan="3" valign="top" class="help_text_i">
        <div class="help_text_i_inner">
            <ul>
                <li>Admin can change the password by providing old and new password.</li><br />
            </ul>
