<%@ Page Title="" Language="C#" MasterPageFile="~/CourseAdmin/CourseAdmin.Master" AutoEventWireup="true" CodeBehind="ExamConfirmationPage.aspx.cs" Inherits="SecureProctor.CourseAdmin.ExamConfirmationPage" %>
                                    ...
                                    <td>
                                        <table cellpadding="3" cellspacing="4" width="100%" border="0">
                                            <tr class="gridviewRowstyle">
                                                <td align="left" width="20%">&nbsp;&nbsp;&nbsp; <strong>Course Name</strong>
                                                </td>
                                            ...
                                            <tr class="gridviewAlternatestyle">
                                                <td align="left">&nbsp;&nbsp;&nbsp; <strong>Duration</strong>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr class="gridviewRowstyle">
                                                <td align="left">&nbsp;&nbsp;&nbsp; <strong>Extended time for special accommodations students </strong>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr class="gridviewAlternatestyle">
                                                <td align="left">&nbsp;&nbsp;&nbsp; <strong>Link to access Exam</strong>
                                                </td>
                                            ...
                                            <tr class="gridviewRowstyle">
                                                <td align="left">&nbsp;&nbsp;&nbsp; <strong>Exam Start Date</strong>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr class="gridviewAlternatestyle">
                                                <td align="left">&nbsp;&nbsp;&nbsp; <strong>Exam End Date</strong>
                                                </td>
                                                <td align="left">
